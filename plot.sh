...
python scripts/generate_plane_jobs.py --grid-size=31 --magnitude=1.0 --num-steps=200000 "./runs/${checkpoint_name}_checkpoints/9920007" "./runs/${checkpoint_name}_eig_vecs_plane/"
