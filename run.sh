...
python scripts/generate_eval_jobs.py --num-steps=1000000 --checkpoint=0040000 "./runs/${checkpoint_name}_checkpoints" "./runs/${checkpoint_name}_eig_vecs/"
python scripts/run_jobs_multiproc.py "./runs/${checkpoint_name}_eig_vecs/jobs.sh"
python scripts/generate_plane_jobs.py --dir1="./runs/${checkpoint_name}_eig_vecs/results/0040000/maxeigvec.npz" --dir2="./runs/${checkpoint_name}_eig_vecs/results/0040000 mineigvec.npz" --grid-size=31 --magnitude=1.0 --num-steps=200000 "./runs/${checkpoint_name}_checkpoints/0040000" "./runs/${checkpoint_name}_eig_vecs_plane/"
