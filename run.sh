...
python scripts/generate_plane_jobs.py --dir1="./${checkpoint_name}_eig_vecs/results/0004000/maxeigvec.npz" --dir2="./${checkpoint_name}_eig_vecs/results/0004000/mineigvec.npz" --grid-size=31 --magnitude=1.0 --num-steps=200000 "./${checkpoint_name}_checkpoints/0004000" "./${checkpoint_name}_eig_vecs_plane/"
