...
def main():
    parser = argparse.ArgumentParser(description='Run every job on a seperate process using python multiprocessing')
    parser.add_argument('jobs_fname', type=str, help="Path to jobs file")
